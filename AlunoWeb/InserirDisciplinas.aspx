...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView runat="server" ID="grdDisciplinas" CellPadding="10" CellSpacing="10" 
        AutoGenerateColumns="false" AllowPaging="true" PageSize="5" OnPageIndexChanging="grdDisciplinas_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="NomeDisc" HeaderText="Nome da Disciplina" />
        </Columns>
    </asp:GridView>
